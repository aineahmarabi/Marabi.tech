...
export default function About() {
    return (
        <div className="font-raleway lg:w-[90%]">
            ...
            <p className="text-sm md:text-lg lg:text-lg pb-5 text-justify">Oops! You seem to have stumbled upon our about page. But fear not, brave explorer of the digital realm! You are in for a treat.</p>
            <p className="text-sm md:text-lg lg:text-lg pb-5 text-justify">We are <strong>Marabi</strong>. We build websites, create mobile apps, and implement ERP systems. But that is not really what we do. What we actually do is <strong>solve problems.</strong></p>
            ...
            <p className="text-sm md:text-lg lg:text-lg pb-5 text-justify">Maybe you are <strong>a small business owner</strong> who needs to reach more customers online. Or <strong>a startup founder</strong> with an app idea that could change lives. Perhaps you are <strong>juggling spreadsheets</strong> and wishing for a better way to manage your growing company.<span className="text-sm md:text-lg lg:text-lg font-bold pb-5 text-justify"> That is where we come in.</span></p>
            <p className="text-sm md:text-lg lg:text-lg pb-5 text-justify">We are not here to dazzle you with tech jargon or promise the moon. We are here to listen, understand, and then roll up our sleeves to create something that actually works for you.</p>
            ...
            <p className="text-sm md:text-lg lg:text-lg pb-5 text-[1em] text-justify">
                ...
                Other times it is bringing your <Link href="/services/mobile-apps" className="text-[#3D9BE9] font-bold">Mobile App</Link> idea to life. 
